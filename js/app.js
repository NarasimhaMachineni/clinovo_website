...
(function () {
  ...
  const DEFAULT_SEED_SITES_36 = [
    // --- TEAM MEMBER 1: Dr. Sarah Jenkins (Lead CRA) ---
    {
      ...
      total: 18,
      weeks: 18,
      scores: { invSite: 54, patientPop: 53, facilities: 52, pharmacy: 60, labBiomarker: 55, safety: 43, regulatory: 39, dataTech: 54, budget: 42 },
    ...
    },
    {
      ...
      total: 28,
      weeks: 14,
      scores: { invSite: 81, patientPop: 90, facilities: 67, pharmacy: 68, labBiomarker: 88, safety: 68, regulatory: 90, dataTech: 83, budget: 76 },
    ...
    },
    {
      ...
      total: 38,
      weeks: 11,
      scores: { invSite: 78, patientPop: 87, facilities: 98, pharmacy: 81, labBiomarker: 99, safety: 91, regulatory: 77, dataTech: 78, budget: 82 },
    ...
    },
    {
      ...
      total: 18,
      weeks: 18,
      scores: { invSite: 41, patientPop: 48, facilities: 45, pharmacy: 46, labBiomarker: 55, safety: 54, regulatory: 62, dataTech: 65, budget: 42 },
    ...
    },
    {
      ...
      total: 40,
      weeks: 10,
      scores: { invSite: 99, patientPop: 88, facilities: 99, pharmacy: 82, labBiomarker: 81, safety: 99, regulatory: 84, dataTech: 86, budget: 83 },
    ...
    },
    {
      ...
      total: 16,
      weeks: 19,
      scores: { invSite: 40, patientPop: 53, facilities: 38, pharmacy: 54, labBiomarker: 59, safety: 56, regulatory: 43, dataTech: 40, budget: 48 },
    ...
    // --- TEAM MEMBER 2: Dr. Michael Vance (Senior Protocol Officer) ---
    {
      ...
      total: 36,
      weeks: 12,
      scores: { invSite: 81, patientPop: 99, facilities: 86, pharmacy: 99, labBiomarker: 90, safety: 81, regulatory: 85, dataTech: 86, budget: 99 },
    ...
    },
    {
      ...
      total: 20,
      weeks: 16,
      scores: { invSite: 52, patientPop: 66, facilities: 70, pharmacy: 58, labBiomarker: 58, safety: 49, regulatory: 51, dataTech: 73, budget: 58 },
    ...
    },
    {
      ...
      total: 19,
      weeks: 17,
      scores: { invSite: 55, patientPop: 56, facilities: 49, pharmacy: 66, labBiomarker: 57, safety: 44, regulatory: 61, dataTech: 47, budget: 63 },
    ...
    },
    {
      ...
      total: 15,
      weeks: 20,
      scores: { invSite: 35, patientPop: 40, facilities: 35, pharmacy: 53, labBiomarker: 50, safety: 53, regulatory: 48, dataTech: 38, budget: 35 },
    ...
    },
    {
      ...
      total: 30,
      weeks: 13,
      scores: { invSite: 78, patientPop: 88, facilities: 80, pharmacy: 86, labBiomarker: 89, safety: 89, regulatory: 70, dataTech: 73, budget: 90 },
    ...
    },
    {
      ...
      total: 24,
      weeks: 15,
      scores: { invSite: 65, patientPop: 66, facilities: 69, pharmacy: 80, labBiomarker: 72, safety: 62, regulatory: 68, dataTech: 80, budget: 70 },
    ...
    // --- TEAM MEMBER 3: Dr. Elena Rostova (Global Feasibility Specialist) ---
    {
      ...
      total: 50,
      weeks: 9,
      scores: { invSite: 88, patientPop: 94, facilities: 99, pharmacy: 87, labBiomarker: 85, safety: 93, regulatory: 99, dataTech: 94, budget: 97 },
    ...
    },
    {
      ...
      total: 18,
      weeks: 18,
      scores: { invSite: 59, patientPop: 60, facilities: 46, pharmacy: 42, labBiomarker: 46, safety: 63, regulatory: 42, dataTech: 53, budget: 53 },
    ...
    },
    {
      ...
      total: 26,
      weeks: 14,
      scores: { invSite: 73, patientPop: 62, facilities: 73, pharmacy: 81, labBiomarker: 74, safety: 67, regulatory: 73, dataTech: 75, budget: 69 },
    ...
    },
    {
      ...
      total: 33,
      weeks: 12,
      scores: { invSite: 82, patientPop: 78, facilities: 86, pharmacy: 86, labBiomarker: 90, safety: 78, regulatory: 97, dataTech: 82, budget: 88 },
    ...
    },
    {
      ...
      total: 23,
      weeks: 16,
      scores: { invSite: 73, patientPop: 64, facilities: 67, pharmacy: 60, labBiomarker: 70, safety: 65, regulatory: 72, dataTech: 56, budget: 67 },
    ...
    },
    {
      ...
      total: 29,
      weeks: 13,
      scores: { invSite: 85, patientPop: 67, facilities: 75, pharmacy: 72, labBiomarker: 78, safety: 83, regulatory: 86, dataTech: 77, budget: 89 },
    ...
    // --- TEAM MEMBER 4: Dr. Rajiv Patel (Clinical Operations Lead) ---
    {
      ...
      total: 20,
      weeks: 17,
      scores: { invSite: 51, patientPop: 50, facilities: 55, pharmacy: 61, labBiomarker: 71, safety: 70, regulatory: 63, dataTech: 68, budget: 62 },
    ...
    },
    {
      ...
      total: 37,
      weeks: 11,
      scores: { invSite: 97, patientPop: 83, facilities: 80, pharmacy: 99, labBiomarker: 80, safety: 84, regulatory: 89, dataTech: 84, budget: 79 },
    ...
    },
    {
      ...
      total: 15,
      weeks: 20,
      scores: { invSite: 35, patientPop: 57, facilities: 49, pharmacy: 51, labBiomarker: 46, safety: 52, regulatory: 48, dataTech: 58, budget: 48 },
    ...
    },
    {
      ...
      total: 22,
      weeks: 16,
      scores: { invSite: 69, patientPop: 67, facilities: 51, pharmacy: 54, labBiomarker: 73, safety: 72, regulatory: 74, dataTech: 52, budget: 72 },
    ...
    },
    {
      ...
      total: 31,
      weeks: 13,
      scores: { invSite: 87, patientPop: 74, facilities: 92, pharmacy: 90, labBiomarker: 92, safety: 93, regulatory: 75, dataTech: 92, budget: 85 },
    ...
    },
    {
      ...
      total: 25,
      weeks: 15,
      scores: { invSite: 83, patientPop: 80, facilities: 73, pharmacy: 62, labBiomarker: 69, safety: 80, regulatory: 65, dataTech: 67, budget: 72 },
    ...
    // --- TEAM MEMBER 5: Dr. Sophia Al-Mansoor (Global Site Manager) ---
    {
      ...
      total: 35,
      weeks: 12,
      scores: { invSite: 96, patientPop: 99, facilities: 85, pharmacy: 82, labBiomarker: 99, safety: 89, regulatory: 80, dataTech: 89, budget: 90 },
    ...
    },
    {
      ...
      total: 19,
      weeks: 17,
      scores: { invSite: 61, patientPop: 51, facilities: 58, pharmacy: 49, labBiomarker: 60, safety: 54, regulatory: 47, dataTech: 60, budget: 58 },
    ...
    },
    {
      ...
      total: 28,
      weeks: 14,
      scores: { invSite: 83, patientPop: 85, facilities: 87, pharmacy: 81, labBiomarker: 66, safety: 76, regulatory: 66, dataTech: 77, budget: 74 },
    ...
    },
    {
      ...
      total: 36,
      weeks: 12,
      scores: { invSite: 98, patientPop: 91, facilities: 97, pharmacy: 84, labBiomarker: 83, safety: 87, regulatory: 75, dataTech: 76, budget: 99 },
    ...
    },
    {
      ...
      total: 17,
      weeks: 18,
      scores: { invSite: 48, patientPop: 47, facilities: 55, pharmacy: 48, labBiomarker: 63, safety: 52, regulatory: 49, dataTech: 66, budget: 64 },
    ...
    },
    {
      ...
      total: 30,
      weeks: 13,
      scores: { invSite: 91, patientPop: 74, facilities: 93, pharmacy: 74, labBiomarker: 90, safety: 88, regulatory: 92, dataTech: 94, budget: 79 },
    ...
    // --- TEAM MEMBER 6: Dr. David Lin (Principal Medical Monitor) ---
    {
      ...
      total: 23,
      weeks: 15,
      scores: { invSite: 68, patientPop: 73, facilities: 73, pharmacy: 77, labBiomarker: 74, safety: 78, regulatory: 58, dataTech: 59, budget: 75 },
    ...
    },
    {
      ...
      total: 25,
      weeks: 14,
      scores: { invSite: 79, patientPop: 66, facilities: 82, pharmacy: 63, labBiomarker: 65, safety: 77, regulatory: 69, dataTech: 68, budget: 76 },
    ...
    },
    {
      ...
      total: 41,
      weeks: 10,
      scores: { invSite: 84, patientPop: 99, facilities: 96, pharmacy: 96, labBiomarker: 85, safety: 81, regulatory: 99, dataTech: 88, budget: 81 },
    ...
    },
    {
      ...
      total: 16,
      weeks: 19,
      scores: { invSite: 54, patientPop: 49, facilities: 45, pharmacy: 48, labBiomarker: 55, safety: 50, regulatory: 50, dataTech: 57, budget: 45 },
    ...
    },
    {
      ...
      total: 21,
      weeks: 16,
      scores: { invSite: 71, patientPop: 70, facilities: 66, pharmacy: 52, labBiomarker: 73, safety: 62, regulatory: 71, dataTech: 56, budget: 61 },
    ...
    },
    {
      ...
      total: 27,
      weeks: 14,
      scores: { invSite: 85, patientPop: 72, facilities: 72, pharmacy: 79, labBiomarker: 74, safety: 84, regulatory: 73, dataTech: 62, budget: 62 },
